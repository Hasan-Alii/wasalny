...
class PaymentPage1Widget extends StatefulWidget {

  @override
  _PaymentPage1WidgetState createState() => _PaymentPage1WidgetState();
}

class _PaymentPage1WidgetState extends State<PaymentPage1Widget> {
